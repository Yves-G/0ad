...
void GL4ShaderRenderModifier::SetFrameUniforms()
{
	...
	CStrIntern drawBlock("DrawBlock");
	...
	m_BindingInstancingTransform = uniformBlockManager.GetBinding(drawBlock, str_instancingTransform, true);
	m_BindingModelID = uniformBlockManager.GetBinding(drawBlock, str_modelId, true);
}
